...
insert into book (name, category_id, ordering) values 
  ('Чистый код :: Роберт Мартин — прочитано, все материалы доступны', 1, 1),
  ...
  ('PostgreSQL. Основы языка SQL :: Евгений Моргунов — читаем сейчас', 9, 4),
  ...
  ('Теоретический минимум по Computer Science. Все что нужно программисту и разработчику :: Фило Владстон Феррейра — прочитано, все материалы доступны', 14, 4),
