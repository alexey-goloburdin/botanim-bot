...
по каждой главе, эти материалы попадают в группу в Telegram, а также мы обсуждаем \
все возникающие по ходу чтения вопросы, сложности и наоборот то, что особенно \
нравится в материале.

Если не получается подписаться или есть иные вопросы — sterx@rl6.ru
"""

VOTE = """Я отправил тебе все книги, которые можно выбрать. Вжууух!
